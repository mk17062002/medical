...
<div class="dashboard" style="position: fixed;width: 18%;height: 100%;background:#222D32">
  ...
  <div>
   <li> <div style="background:#1E282C;color: white;padding: 13px 17px;border-left: 3px solid #3C8DBC;"><span><i class="fa fa-dashboard fa-fw"></i> Dashboard</span></div></li>
    <div class="item">
      <ul class="nostyle zero">
        <li><a href="index.php"><li style="color: white"><i class="fa fa-circle-o fa-fw"></i> Home</li></a></li>
